...
namespace NodeCanvas.Tasks.Actions
{
    ...
    public class WanderInSideAreaVector : ActionTask<NavMeshAgent>
    {
        ...
        [RequiredField]
        public BBParameter<Vector3> centerArea;
        ...
        void DoWander()
        {
            ...
            while ( ( wanderPos - agent.transform.position ).sqrMagnitude < ( min * min ) ) {
                wanderPos = ( Random.insideUnitSphere * max ) + centerArea.value;
            }
